...
(function($) {
			...
			try
			{
				...
				if(settings.trackLinks)
				{
					$(external).click(function(){
						...
						if(DEBUG){$.glamLog('external link tracked', 'INFO', pluginname);}
					});
				...
				if(settings.trackMails)
				{
					$(mails).click(function(){
						...
						if(DEBUG){$.glamLog('mailto: link tracked', 'INFO', pluginname);}
					});
				...
				if(settings.trackFiles)
				{
					$(files).click(function(){
						...
						if(DEBUG){$.glamLog('download link tracked', 'INFO', pluginname);}
					});
	...
	$.glamGA.customTrack = function(uatracker, settings)
	{
		...
		function trackIt()
		{
			...
			if(settings.type == 'event')
			{
				...
				if(DEBUG){$.glamLog('custom event tracked', 'INFO', pluginname);}
			}
			else if(settings.type == 'view')
			{
				pageTracker._trackPageview(settings.url);
				if(DEBUG){$.glamLog('custom pageview tracked', 'INFO', pluginname);}
			}
		}
	...
	{	
		settings = $.extend({}, $.glamGA.customdefaults, settings);
		return this.bind(settings.event + '.glamGA', function() {
